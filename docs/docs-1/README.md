...
Contattaci attraverso il [forum ufficiale](https://forum.openstamanager.com) oppure su [GitHub](https://github.com/devcode-it/devcode-it.github.io/issues). :smile:
