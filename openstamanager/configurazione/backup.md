...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/imnORsInuaaXiiRnlr6m/openstamanager/configurazione/backup
---
...
Il percorso di backup può essere configurato tramite apposita impostazione **Adattatore archiviazione backup,** presente nella sezione Backup.
...
Per creare un nuovo backup si dovrà cliccare su Crea nuovo backup.
