...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/J2nSTzHfzyz9ea0M9aP3/openstamanager/modules/contabilita
---
...
{% content-ref url="ammortamenti-cespiti.md" %}
[ammortamenti-cespiti.md](ammortamenti-cespiti.md)
{% endcontent-ref %}
