...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/J2nSTzHfzyz9ea0M9aP3/openstamanager/modules/strumenti/impostazioni
---
...
**Geolocalizzazione automatica:** Se questa impostazione è abilitata, viene effettuata la geolocalizzazione automatica delle nuove anagrafiche e sedi inserite.
...
**Endpoint ibanapi.com:** di default [https://api.ibanapi.com](https://api.ibanapi.com)

**Api key ibanapi.com**

**OpenRouter API Key:** API key per l'integrazione con OpenRouter AI.

**Modello AI predefinito (OpenRouter):** Modello gratuito da utilizzare per impostazione predefinita con l'assistente AI di OpenRouter.

**Prompt di sistema per Modello AI:** Il messaggio di sistema inviato all'AI per definire il suo ruolo e comportamento. Modificalo per personalizzare le risposte.
...
**Cambia automaticamente stato attività fatturate:** Se questa impostazione è abilitata, lo stato Fatturato non sarà più selezionabile manualmente per le attività, ma verrà impostato in maniera automatica alla creazione di una fattura.

**Raggruppamento fatturazione massiva attività:** Seleziona se raggruppare le attività per sede o per cliente, in fase di fatturazione massiva da azioni di gruppo.
...
**Adattatore archiviazione backup:** E' qui possibile definire il percorso per i backup

**Password di protezione backup:** Password da utilizzare per proteggere i backup in formato ZIP

### Contratti

**Condizioni generali di fornitura contratti:** Le condizioni qui inserite verranno riportate in tutti i nuovi contratti creati dal momento della modifica di questa impostazione. Non verranno perciò modificati i contratti precedenti.<br>
...
**Cambia automaticamente stato contratti fatturati:** Se questa impostazione è abilitata, lo stato Fatturato non sarà più selezionabile manualmente per i contratti, ma verrà impostato in maniera automatica alla creazione di una fattura.

**Raggruppamento fatturazione massiva contratti:** Seleziona se raggruppare i contratti per sede o per cliente.
...
**Raggruppamento fatturazione massiva ddt:** Seleziona se raggruppare i DDT per sede o per cliente.

**Raggruppa gli articoli con stesso barcode nei DDT:** se abilitata, raggruppa gli articoli, altrimenti non li raggruppa.
...
**Metodo di importazione XML fatture di vendita:** E' possibile qui abilitare l'importazione automatica o guidata per le fatture di vendita caricate manualmente in formato ZIP da apposito plugin&#x20;

**Conto predefinito per le spese d'incasso:** E' qui possibile definire il conto da associare alle spese d'incasso
...
**Gestore mappa:** E' possibile scegliere tra OpenStreetMap e Google Maps

**Tile server satellite:** Di default [https://server.arcgisonline.com/ArcGIS/rest/services/World\_Imagery/MapServer/tile/{z}/{y}/{x}](https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/%7Bz%7D/%7By%7D/%7Bx%7D)

**Rendi casuale il nome dei file allegati:** Se abilitato, imposta un nome casuale ai file allegati, se disabilitato, mantiene i nomi originali.

**Tempolate email richiesta codice OTP:** E' qui possibile definire un template email per la richiesta dell'accesso tramite OTP
...
**Raggruppamento fatturazione massiva ordini:** Seleziona se raggruppare per cliente o sede in fase di fatturazione massiva degli ordini
...
**Conto per Iva transitoria:** Di default 000040 - Iva transitoria

**Conto predefinito per i cespiti:** Di default Immobilizzazioni

**Conto predefinito per gli ammortamenti:** Di default Fondi ammortamento
...
**Raggruppamento fatturazione massiva preventivi:** E' qui possibile definire se raggruppare i preventivi per sede o cliente in fase di fatturazione massiva
