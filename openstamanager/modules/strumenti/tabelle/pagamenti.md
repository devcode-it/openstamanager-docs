...
Volendo aggiungere alle modalità di pagamento il **Bonifico 30gg d.f.f.m + 10** si dovrà aggiungere un nuovo tipo di pagamento che riporterà una rata del 100% dell'importo complessivo, a 300 giorni dalla data di emissione della fattura (Da specificare nel campo **Distanza in giorni**).
