...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/I8PynmXUVfCOtwZFC1I6/openstamanager/modules/strumenti/aggiornamenti
---
...
* [Cercare gli aggiornamenti disponibili](aggiornamenti.md#ricerca-aggiornamenti)
* C[aricare un aggiornamento](aggiornamenti.md#carica-un-aggiornamento)
* Controllare l'integrità dei file del gestionale
* Controllare l'integrità del database
* Controllare i problemi sul gestionale
{% endhint %}
