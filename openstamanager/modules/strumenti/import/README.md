...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/I8PynmXUVfCOtwZFC1I6/openstamanager/modules/strumenti/import
---

# Import

{% hint style="info" %}
Il modulo **Import** permette di caricare dei file CSV per aggiungere dei record nei moduli _Anagrafiche, Articoli, Attività, Impianti, Listini cliente, Piano dei conti e Preventivi_
{% endhint %}
...
* Piano dei conti (informazioni sulla creazione del file CSV su [Import piano dei conti](import-partitario.md))
...
Una volta creato il file CSV si dovrà cliccare su Sfoglia nel campo **File,** e andare a selezionarlo per il caricamento.
...
* definire se importare anche la prima riga del file CSV come record
* definire se aggiornare i record esistenti
* definire se creare i record mancanti
...
{% content-ref url="import-partitario.md" %}
[import-partitario.md](import-partitario.md)
{% endcontent-ref %}
