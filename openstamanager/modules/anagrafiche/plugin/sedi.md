...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/imnORsInuaaXiiRnlr6m/openstamanager/modules/anagrafiche/plugin/sedi
---
...
* Codice destinatario
* Automezzo
* [Rappresentante fiscale](sedi.md#rappresentante-fiscale)
* Referenti
* Nome, targa e descrizione automezzo
...
Se questo flag è abilitato, all'emissione di una fattura con abilitato il flag **Fattura per conto terzi** nei confronti di questa anagrafica, verrà valorizzato nell'XML il nodo RappresentanteFiscale.
