...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/imnORsInuaaXiiRnlr6m/openstamanager/modules/anagrafiche/plugin
---
...
{% content-ref url="assicurazione-crediti.md" %}
[assicurazione-crediti.md](assicurazione-crediti.md)
{% endcontent-ref %}
