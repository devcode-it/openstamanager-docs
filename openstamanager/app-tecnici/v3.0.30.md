...
![](<../../.gitbook/assets/immagine (174).png>)Per poter utilizzare l'app è necessario accedere con un utente facente parte il gruppo tecniciPer poter utilizzare l'app è necessario accedere con un utente facente parte il gruppo tecnici
