...
Per gestire il **Consuntivo** di un contratto a ore è necessario [creare un Contratto](../../esempi/broken-reference/), e successivamente creare delle **Attività** collegate.
