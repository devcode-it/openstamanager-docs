...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/imnORsInuaaXiiRnlr6m/guide/esempi
---
...
{% content-ref url="attivita-per-conto-di.md" %}
[attivita-per-conto-di.md](attivita-per-conto-di.md)
{% endcontent-ref %}
...
{% content-ref url="generazione-di-una-chiave-di-licenza-wacom.md" %}
[generazione-di-una-chiave-di-licenza-wacom.md](generazione-di-una-chiave-di-licenza-wacom.md)
{% endcontent-ref %}
...
{% content-ref url="gestione-provvigioni-agenti.md" %}
[gestione-provvigioni-agenti.md](gestione-provvigioni-agenti.md)
{% endcontent-ref %}

{% content-ref url="impostare-logo-nelle-stampe.md" %}
[impostare-logo-nelle-stampe.md](impostare-logo-nelle-stampe.md)
{% endcontent-ref %}
...
{% content-ref url="invio-automatico-di-solleciti-di-pagamento.md" %}
[invio-automatico-di-solleciti-di-pagamento.md](invio-automatico-di-solleciti-di-pagamento.md)
{% endcontent-ref %}
...
{% content-ref url="stampa-inventario.md" %}
[stampa-inventario.md](stampa-inventario.md)
{% endcontent-ref %}
...
{% content-ref url="contabilizzare-una-ri.ba..md" %}
[contabilizzare-una-ri.ba..md](contabilizzare-una-ri.ba..md)
{% endcontent-ref %}
