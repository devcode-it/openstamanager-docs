...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/imnORsInuaaXiiRnlr6m/guide/esempi/tasks-programmati
---
...
{% content-ref url="../../openstamanager/modules/strumenti/gestione-task/" %}
[gestione-task](../../openstamanager/modules/strumenti/gestione-task/)
{% endcontent-ref %}

![](<../../.gitbook/assets/immagine (1043).png>)
